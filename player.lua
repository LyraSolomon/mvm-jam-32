...
local jump_buffer_max = 500
local jump_buffer_timer = jump_buffer_max
...
function player:update(dt)
	...
	util.clamp(jump_buffer_timer, jump_buffer_max, 0)
end
...
function player:input()
	...
	if input.pressed(input.BTN1) and (self.aabb.normal.y == -1 or jump_buffer_timer == 0) then
